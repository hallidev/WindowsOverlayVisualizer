...
namespace Assets.Scripts.Interop
{
    public static class NativeMethods
    {
        ...
        public static extern int UpdateLayeredWindow(IntPtr handle, IntPtr hdcDst, ref Point pptDst, ref Size psize, IntPtr hdcSrc, ref Point pprSrc, int crKey, ref BlendFunction pblend, int dwFlags);
